...
int main(int argc, char* argv[]) {
		...
		Pokemon* Rapidash = new Pokemon("Rapidash", Fire, Fire, new Attack_Move("Fire Blast", new Fire_Move(), 70, 0, 120), new Attack_Move("Flamethrower", new Fire_Move(), 100, 0, 90), new Debuff_Move("Tail Whip", a, 100, 0, 1, 2), new Attack_Move("Quick Attack", new Normal_Move(), 100, 1, 40), 106, 90, 68, 94);
		Pokemon* Ponyta1 = new Pokemon("Ponyta", Fire, Fire, new Attack_Move("Ember", new Fire_Move(), 100, 0, 40), new Attack_Move("Flame Charge", new Fire_Move(),  100, 0, 50), new Buff_Move("Agility", a, 100, 0, 3, 2), new Debuff_Move("Tail Whip", a, 100, 0, 1, 2), 106, 85, 61, 89);
        Pokemon* Ponyta2 = new Pokemon("Ponyta", Fire, Fire, new Attack_Move("Ember", new Fire_Move(), 100, 0, 40), new Attack_Move("Flame Charge", new Fire_Move(),  100, 0, 50), new Buff_Move("Agility", a, 100, 0, 3, 2), new Debuff_Move("Tail Whip", a, 100, 0, 1, 2), 106, 85, 61, 89);
        Pokemon* Ponyta3 = new Pokemon("Ponyta", Fire, Fire, new Attack_Move("Ember", new Fire_Move(), 100, 0, 40), new Attack_Move("Flame Charge", new Fire_Move(),  100, 0, 50), new Buff_Move("Agility", a, 100, 0, 3, 2), new Debuff_Move("Tail Whip", a, 100, 0, 1, 2), 106, 85, 61, 89);
		Pokemon* Arcanine = new Pokemon("Arcanine", Fire, Fire, new Attack_Move("Fire Blast", new Fire_Move(), 70, 0, 120), new Attack_Move("Flamethrower", new Fire_Move(), 100, 0, 90), new Buff_Move("Agility", a, 100, 0, 3, 2), new Attack_Move("Extreme Speed", new Normal_Move(), 100, 1, 80), 131, 102, 79, 91);
		...
		Pokemon* Ninetales = new Pokemon("Ninetales", Fire, Fire, new Attack_Move("Fire Blast", new Fire_Move(), 70, 0, 120), new Attack_Move("Flamethrower", new Fire_Move(), 100, 0, 90), new Buff_Move("Nasty Plot", a, 100, 0, 1, 2), new Attack_Move("Quick Attack", new Normal_Move(), 100, 1, 40), 124, 95, 93, 110);
		Pokemon* Vulpix1 = new Pokemon("Vulpix", Fire, Fire, new Attack_Move("Ember", new Fire_Move(), 100, 0, 40), new Attack_Move("Flamethrower", new Fire_Move(), 100, 0, 90), new Debuff_Move("Tail Whip", a, 100, 0, 1, 2), new Attack_Move("Quick Attack", new Normal_Move(), 100, 1, 40), 88, 47, 47, 66);
        Pokemon* Vulpix2 = new Pokemon("Vulpix", Fire, Fire, new Attack_Move("Ember", new Fire_Move(), 100, 0, 40), new Attack_Move("Flamethrower", new Fire_Move(), 100, 0, 90), new Debuff_Move("Tail Whip", a, 100, 0, 1, 2), new Attack_Move("Quick Attack", new Normal_Move(), 100, 1, 40), 88, 47, 47, 66);
